...
uint16_t cp_get_a(int idx){ return cp[idx].a; }
uint16_t cp_get_b(int idx){ return cp[idx].b; }
const char* cp_get_str(int idx){ return cp[idx].str; }
uint8_t cp_get_tag(int idx){ return cp[idx].tag; }
